const emojipedia = [{
    ...
    },
    {
        ...
        emoji: "😜",
        name: "Winking Eye",
        meaning: "Smiley boldly sticks out the tongue, winking with one eye. Has made a joke or wants to flirt with the chat partner. Is carefree and does not mean it seriously."
    },
    {
        id: 16,
        emoji: "🤨",
    ...
    },
    {
        ...
        emoji: "🤥",
        name: "Lying Face",
        meaning: "As with Pinocchio, the nose becomes longer with each lie, which exposes him as a liar. Symbol of a falsehood, boast, or an unlikely story."
    },
    {
        id: 23,
        emoji: "🤤",
        name: "Drooling Face",
        meaning: "Slobbering face, the saliva flowing from the corner of the mouth. Represents desire for a person, delicious food, the new car, or the anticipation of an event. Expression of extreme interest and desire."
    },
    {
        id: 24,
        emoji: "👺",
        name: "Japanese Goblin",
        meaning: "The Tengu (literally: heavenly dog) is an evil and magical being from Japan. Has supernatural powers and brings forth disaster. The red mask has eyebrows and a beard and a noticeably long nose."
    },
    {
        id: 25,
        emoji: "👻",
