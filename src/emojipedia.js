const emojipedia = [{
  ...
  },
  {
    ...
    emoji: "👍",
    name: "Thumb up",
    meaning: "It is the well-known symbol of approval and liking something — and the emoji, based on this gesture, is used online exactly in the same meaning."
  },
  {
    id: 39,
    emoji: "👎",
    name: "Thumb down",
    meaning: "Is the opposite to its one as well. The gesture itself is the worldly recognized symbol of disapproval, disliking, or not agreeing."
  },
  {
    id: "40",
    emoji: "🙌",
    name: "Raising Hand",
    meaning: "This body position in real life is typically associated with celebration and enjoying success — so, this emoji is often used in exactly these meanings."
  },
  {
    id: "41",
    emoji: "🤞",
    name: "Crossed Finger",
    meaning: "Which is commonly used when wishing good luck. And this emoji is used exactly in the same meanings its base gesture is used in real life",
  },
  {
    id: "42",
    emoji: "🤜",
    name: "Right-Facing",
    meaning: " It looks like a hand made into a fist, which is pointing to the right. "
  },
  {
    id: "43",
    emoji: "🤛",
    name: "Left-Facing",
    meaning: "Base-gesture in real life, these two emojis together serve as a symbol of friendship, solidarity, respect, and support; as well, sometimes they are also used instead of saying “hi” or “bye” to a friend by many young people."
  },
  {
    id: "44",
    emoji: "💪",
    name: "Flexed Biceps",
    meaning: "Flexed Biceps emoji represents the arm with tense, enlarged bicep. It is often used both in its direct and indirect meanings. The first is everything related to working out, sports, bodybuilding, fitness, and physical strength."
  }
